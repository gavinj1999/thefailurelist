<template>
    <SiteLayout>
        <Search :members="members" :parties="parties" @siteSearch="memberSearch" @siteSort="siteSorter" @partyFilter="handlePartyFilter"  @clearPartyFilter="handleClearPartyFilter"/>
